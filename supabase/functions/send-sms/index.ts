...
function getSmsBody(type: SmsType, data: Record<string, any>): string {
  switch (type) {
    ...
    case "lease_sent":
      return `Hi ${data.first_name}, your lease agreement has been sent for e-signature. Please check your email from SignWell and sign at your earliest convenience. - AWKN Ranch`;
